...
class TestSettingsPage:
    async def test_get_settings_returns_200(self, logged_in_client: AsyncClient) -> None:
        response = await logged_in_client.get("/admin/settings")
        assert response.status_code == 200

    async def test_settings_page_contains_nvr_group(self, logged_in_client: AsyncClient) -> None:
        response = await logged_in_client.get("/admin/settings")
        assert "NVR" in response.text

    async def test_settings_page_contains_email_group(self, logged_in_client: AsyncClient) -> None:
        response = await logged_in_client.get("/admin/settings")
        assert "Email" in response.text

    async def test_settings_page_contains_readonly_section(self, logged_in_client: AsyncClient) -> None:
        response = await logged_in_client.get("/admin/settings")
...
class TestSaveCoreSettings:
    ...
    async def test_save_nvr_new_password_overwrites(self, logged_in_client: AsyncClient) -> None:
    ...
    async def test_save_location_group(self, logged_in_client: AsyncClient) -> None:
        response = await logged_in_client.post(
    ...
    async def test_save_returns_toast_html(self, logged_in_client: AsyncClient) -> None:
        response = await logged_in_client.post(
            "/admin/settings/core/location",
    ...
    async def test_unknown_group_returns_404(self, logged_in_client: AsyncClient) -> None:
        response = await logged_in_client.post(
...
class TestSavePluginSettings:
    async def test_save_hot_water_plugin_settings(self, logged_in_client: AsyncClient) -> None:
        response = await logged_in_client.post(
    ...
    async def test_save_plugin_returns_toast(self, logged_in_client: AsyncClient) -> None:
        response = await logged_in_client.post(
            "/admin/settings/plugin/hot_water",
            data={
    ...
    async def test_unknown_plugin_returns_404(self, logged_in_client: AsyncClient) -> None:
        response = await logged_in_client.post(
