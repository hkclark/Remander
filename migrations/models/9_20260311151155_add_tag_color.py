...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "tag" ADD "color" VARCHAR(50);
        """
...
MODELS_STATE = (
    ...
    "2b5BCL2kNs+k5zo9pdPrqm6WYdOQoJE2ZzXfw+G5JbXKoKDVoCqqHW2uB9Wt4FH0JnTNo7"
    "AwVLLgUUJ9omseRdWQtit45BmhudrSneUqKil1yW3P1ZecYARXmBqkMEENKIxPOGUfRSFB"
    "E1Wm3XxpVLEMFaxKp+bQdI0823eCqAEs60XH8m+JD9sykKYIOabhuaM/wVIfcwoJKsHwAP"
    "a5YsluCd4NvjIW0fEL6ylM55rCYMy1kAZk3LjkAaOjCBjx7LGDWNjNL8qAGTazrQrKvxNj"
    "TnQnK1YA/oDcFmuN3wiXDCs4AVy+OSxHK8Yt46ZZxkQUWjbQjLLSNkHIhW3NTlH+AfDcvK"
    "8yHwDXsCzSGdIlG8aIoqEXaSr/OrAB7JIeDru5jo2LQhHLi5yI5UU6YuketKUOuRgFTwRK"
    "+O63zGMJggT1w69oFkuMNeqUwxLWoGXopPH6tNnqaCJzmSuiddubeYroMeW07MRx64b+S5"
    "fgSVI1U1/ZVbY/9zEeqHXEfYwHsbBb+Bh5lZk3cjaK0FRmS5ZG5/fk6nMgGsOVuQYpc8/Q"
    "tPx9U1QRiZE0UwvZiVJHtkYJEP3hzQRwJ5ne+C/avkBOgphdwSVGwmu4pGu4lDhwqz9YXv"
    "8PnhwCuw=="
)
